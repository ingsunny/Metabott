        ...
        <div class="mx-auto">
          <div class="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-8 py-10 max-w-sm mx-auto sm:max-w-3xl lg:max-w-full">
            <div class="col-span-full  lg:col-span-2 lg:mb-0">
              ...
              <a
                href="javascript:;"
                class="py-2.5 px-5 h-9 block w-fit bg-[#5c0601] cursor-pointer hover:bg-[#660803] rounded-full shadow-sm text-xs text-white transition-all  duration-500 lg:mx-0"
              >
                Contact us
              </a>
            </div>
            <div class="lg:mx-auto text-left ">
              <h4 class="text-lg text-gray-500 font-medium mb-7">Metabott</h4>
            ...
            <div class="lg:mx-auto text-left ">
              <h4 class="text-lg text-gray-500 font-medium mb-7">Courses</h4>
              <ul class="text-sm  transition-all duration-500">
                <li class="mb-6">
                  <a
                    href="javascript:;"
            ...
            <div class="lg:mx-auto text-left ">
              <h4 class="text-lg text-gray-500  font-medium mb-7">Support</h4>
              <ul class="text-sm  transition-all duration-500">
                <li class="mb-6">
                  <a
                    href="javascript:;"
            ...
            <div class="lg:mx-auto text-left ">
              ...
              <a
                href="javascript:;"
                class="flex items-center justify-center gap-2 border border-[#5c0601] rounded-full py-3 px-6 w-fit lg:mx-0  text-sm text-[#5c0601] font-semibold transition-all duration-500 hover:bg-indigo-50"
              >
                Subscribe
                <svg
                  width="15"
          ...
          <div class="py-7 border-t border-gray-200">
            <div class="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
              <span class="text-sm text-gray-500 ">
                ©<a href="https://pagedone.io/">Metabott</a> 2025, All rights
                reserved.
              </span>
