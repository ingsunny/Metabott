...
const WhyUs = () => {
  return (
    <>
      <section className="overflow-hidden max-w-screen-md lg:max-w-screen-xl py-16 px-5 m-auto bg-white ">
        <div className=" mx-auto">
          <div className="flex flex-wrap items-center justify-between ">
            ...
            <div className="w-full w-4/12 lg:w-5/12">
              <div className="mt-10 lg:mt-0">
                <span className="block mb-4 text-lg font-semibold text-[#5c0601] ">
                  Why Choose Us
                </span>
                <h2 className="mb-5 text-3xl font-bold text-gray-900 sm:text-[40px]/[48px]">
                  Empower Your Career with Full Stack Training
                </h2>
                <p className="mb-5 text-base text-gray-600">
                  We don’t just teach – we prepare you for real-world
                  development. Our programs are crafted by industry experts to
                  match what top tech companies need today.
                </p>
                <p className="mb-8 text-base text-gray-600">
                  From hands-on projects and live mentorship to job assistance
                  and real client exposure, our goal is to turn every learner
